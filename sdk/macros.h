...
template<typename T>
__forceinline T g2et_vfunc(void* base, int index) { return (*static_cast<T**>(base))[index]; }
...
#define VFUNC(func, index, type, ...) auto func { return g2et_vfunc<type>(this, index)(this, __VA_ARGS__); };

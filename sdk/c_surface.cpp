...
void Drawing::CreateFonts()
{
	...
	surface()->SetFontGlyphSet(F::Events =surface()->CreateFont_(), _("Trebuchet MS"), 10, NULL, NULL, NULL, FONTFLAG_DROPSHADOW);
...
void Drawing::Triangle(c_vector3d ldcorner, c_vector3d rucorner, c_color col)
{
	...
	DrawLine(ldcorner.x, ldcorner.y, rucorner.x, ldcorner.y, col); // down shit
}
...
{
	c_vector3d boxc_vector3ds0, boxc_vector3ds1, boxc_vector3ds2, boxc_vector3ds3, boxc_vector3ds4, boxc_vector3ds5, boxc_vector3ds6, boxc_vector3ds7;

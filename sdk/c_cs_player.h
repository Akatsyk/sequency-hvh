...
{
	vfunc(284, weapon_shoot_position(c_vector3d& pos), void(__thiscall*)(c_cs_player*, c_vector3d&))(pos) //crashes here idk why. nvm, crashes wherever xd
public:
	enum class hitbox
	{
		head,
	...
	netvar(get_punch_angle2(), c_qangle, "CCSPlayer", "m_aimPunchAngle")
	...
	netvar(m_vphysicsCollisionState(), int, "CCSPlayer", "m_vphysicsCollisionState")
	...
	//vfunc(10, get_abs_origin_2(), const c_vector3d& (__thiscall*)(c_cs_player*))()
	...
	//c_vector3d get_eye_pos();
	c_vector3d get_shoot_position();

	bool is_shooting(c_user_cmd* cmd, float time);
	bool can_shoot(c_user_cmd* cmd, float time, c_base_combat_weapon* weapon, bool manual_shot = false);
